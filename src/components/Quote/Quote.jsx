...
const Quote = () => {
  return (
    <div>
      <div className="Quote">
        <p>“I am still a child. This job doesn't deserve me. I'd like us all to be able to study and 
            put an end to these mining stories,” said Faustin. “I regret the time I spent in the mines. 
